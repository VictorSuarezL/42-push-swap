...
void handle_negative_steps_sort_reverse(t_list *tmp, t_list **stack_a, t_list **stack_b)
{
...
void handle_positive_steps_sort_reverse(t_list *tmp, t_list **stack_a, t_list **stack_b)
{
    if (tmp->steps_a > 0 && tmp->steps_b > 0)
    {
...
{
    t_list *tmp = get_node(*stack_b, pos);
